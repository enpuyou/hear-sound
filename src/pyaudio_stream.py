# code import from tr1pzz/Realtime_PyAudio_FFT
# https://github.com/tr1pzz/Realtime_PyAudio_FFT/blob/master/src/stream_reader_pyaudio.py
__author__ = "Xander Steenbrugge"
